...
networks = {}
feat_net_opt = {'num_classes': 4, 'num_inchannels': 1, 'num_stages': 4, 'use_avg_on_conv3': False}
feat_pretrained_file = './experiments/MNIST_Base_Model/model_net_epoch10'
...
cls_net_opt = {'num_classes':10, 'nChannels':192*7*7, 'cls_type':'MultLayer'}
